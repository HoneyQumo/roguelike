...
namespace
{
	class NoiseListenersTest : public ::testing::Test
	{
	protected:
		void SetUp() override
		{
		...
		ThreatWatchComponent* CreateWatcher()
		{
			GameObject* owner = GameWorld::Instance()->CreateGameObject("Player");
			ThreatWatchComponent* watcher = owner->AddComponent<ThreatWatchComponent>();
...
// \u0413\u043b\u0430\u0432\u043d\u044b\u0439 \u0441\u043b\u0443\u0447\u0430\u0439: \u043f\u043e\u0441\u043b\u0435 \u0440\u0435\u0441\u0442\u0430\u0440\u0442\u0430 \u0441\u0442\u0430\u0440\u0430\u044f \u043b\u044f\u043c\u0431\u0434\u0430 \u0437\u0432\u0430\u043b\u0430\u0441\u044c \u0441 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c \u043d\u0430 \u0441\u043d\u0435\u0441\u0451\u043d\u043d\u044b\u0439 \u043a\u043e\u043c\u043f\u043e\u043d\u0435\u043d\u0442.
TEST_F(NoiseListenersTest, AListenerLeavesTheListWithItsOwner)
{
	ASSERT_EQ(RoguelikeGame::NoiseListenerCount(), 0u);

	CreateWatcher();
	ASSERT_EQ(RoguelikeGame::NoiseListenerCount(), 1u) << "\u043a\u043e\u043c\u043f\u043e\u043d\u0435\u043d\u0442 \u043d\u0435 \u043f\u043e\u0434\u043f\u0438\u0441\u0430\u043b\u0441\u044f \u043d\u0430 \u0448\u0443\u043c";

	GameWorld::Instance()->Clear();

	EXPECT_EQ(RoguelikeGame::NoiseListenerCount(), 0u) << "\u043f\u043e\u0434\u043f\u0438\u0441\u043a\u0430 \u043f\u0435\u0440\u0435\u0436\u0438\u043b\u0430 \u043a\u043e\u043c\u043f\u043e\u043d\u0435\u043d\u0442";
}

// \u0420\u0435\u0441\u0442\u0430\u0440\u0442 \u0437\u0430\u0431\u0435\u0433\u0430: \u0441\u043a\u043e\u043b\u044c\u043a\u043e \u0440\u0430\u0437 \u043d\u0438 \u043d\u0430\u0447\u0438\u043d\u0430\u0439, \u0441\u043b\u0443\u0448\u0430\u0442\u0435\u043b\u044c \u043e\u0441\u0442\u0430\u0451\u0442\u0441\u044f \u043e\u0434\u0438\u043d.
TEST_F(NoiseListenersTest, RestartingDoesNotPileUpListeners)
{
	for (int run = 0; run < 3; run++)
	{
		CreateWatcher();
		EXPECT_EQ(RoguelikeGame::NoiseListenerCount(), 1u) << "\u0437\u0430\u0431\u0435\u0433 " << run;

		GameWorld::Instance()->Clear();
	}

	EXPECT_EQ(RoguelikeGame::NoiseListenerCount(), 0u);
}

// Start \u0437\u043e\u0432\u0443\u0442 \u0441\u043d\u043e\u0432\u0430 \u043f\u0440\u0438 \u0441\u043c\u0435\u043d\u0435 \u043b\u043e\u043a\u0430\u0446\u0438\u0438 - \u0432\u0442\u043e\u0440\u043e\u0439 \u043f\u043e\u0434\u043f\u0438\u0441\u043a\u0438 \u043f\u043e\u044f\u0432\u0438\u0442\u044c\u0441\u044f \u043d\u0435 \u0434\u043e\u043b\u0436\u043d\u043e.
TEST_F(NoiseListenersTest, StartingTwiceKeepsOneSubscription)
{
	ThreatWatchComponent* watcher = CreateWatcher();

	watcher->Start();

	EXPECT_EQ(RoguelikeGame::NoiseListenerCount(), 1u) << "\u043f\u043e\u0434\u043f\u0438\u0441\u043a\u0438 \u043d\u0430\u043a\u0430\u043f\u043b\u0438\u0432\u0430\u044e\u0442\u0441\u044f";
}

TEST_F(NoiseListenersTest, AnUnsubscribedListenerStopsHearing)
{
	int heard = 0;
	XYZEngine::SubscriptionId subscription = RoguelikeGame::SubscribeNoiseRaised([&heard](const RoguelikeGame::Noise&) { heard++; });

	RoguelikeGame::Noise noise;
	noise.position = {0.f, 0.f};
	noise.radius = 500.f;

	RoguelikeGame::RaiseNoise(noise);
	ASSERT_EQ(heard, 1);

	RoguelikeGame::UnsubscribeNoiseRaised(subscription);
	RoguelikeGame::RaiseNoise(noise);

	EXPECT_EQ(heard, 1) << "\u043e\u0442\u043f\u0438\u0441\u0430\u0432\u0448\u0438\u0439\u0441\u044f \u0432\u0441\u0451 \u0435\u0449\u0451 \u0441\u043b\u044b\u0448\u0438\u0442";
	EXPECT_EQ(RoguelikeGame::NoiseListenerCount(), 0u);
}
