...
namespace RoguelikeGame
{
    struct EnemyConfig
    {
        ...
        /**
        *	Градусов в секунду на разворот.
        *
        *	Без ограничения спина у врага появляется и исчезает за один кадр, и зайти
        *	за неё невозможно: конус зрения едет за корпусом мгновенно. Ноль - мгновенный
        *	поворот, как раньше.
        */
        float turnSpeed = 0.f;
    };
