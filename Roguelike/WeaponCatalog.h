...
namespace RoguelikeGame
{
    ...
    */
    ...
    constexpr WeaponDefinition WEAPONS[WEAPON_COUNT] = {
        ...
        {"shotgun_double", u8"Дробовик двуствольный", 2, 53.60f, 12.16f, 1.50f, 1.35f, BulletKind::Pellet, AmmoKind::Shell, 2, 1.30f, "shotgun_double_shot", "shotgun_double_reload"},
        {"shotgun_pump", u8"Дробовик помповый", 3, 55.20f, 11.52f, 1.35f, 1.25f, BulletKind::Pellet, AmmoKind::Shell, 6, 1.90f, "shotgun_pump_shot", "shotgun_pump_reload"},
        {"smg_suppressed", u8"ПП с глушителем", 4, 57.60f, 12.16f, 0.60f, 0.35f, BulletKind::Pistol, AmmoKind::Smg, 25, 1.30f, "smg_silenced_shot", "smg_silenced_reload"},
        ...
        {"pistol_suppressed", u8"Пистолет с глушителем", 7, 56.00f, 12.16f, 0.50f, 0.30f, BulletKind::Pistol, AmmoKind::Pistol, 12, 1.20f, "pistol_silenced_shot", "pistol_silenced_reload"},
